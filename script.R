...
# Labels   
  labs(color = "Organization Name",
       title = "Average Movement of Shelter Home occupancy across years",
       subtitle = "\nThis plot takes a look at the average number of occupants per month for different organizations,
